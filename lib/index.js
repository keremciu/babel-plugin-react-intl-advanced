...
function _default(_ref) {
  ...
  function isFormatMessageCall(path) {
    if (t.isMemberExpression(path)) {
      ...
      var formatMessageKeys = ["formatMessage", "formatHTMLMessage"];
  ...
  return {
    ...
    visitor: {
      JSXOpeningElement: function JSXOpeningElement(path, state) {
        ...
        var additionalComponents = opts.additionalComponentNames || {
          intl: ["formatMessage"]
        };
      ...
      CallExpression: function CallExpression(path, state) {
        ...
        var additionalFunctionNames = state.opts.additionalFunctionNames || {
          intl: ["formatMessage"]
        };
